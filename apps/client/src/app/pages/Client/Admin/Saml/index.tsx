    ...
    return(
       <div className="">
        <Card className="rounded-4">
            <Card.Body>
                <br/>
                <h5 className="mb-0 mx-4">SAML</h5>
                ...
                <Container>
                    ...
                    <div className="w-100 d-flex">
                        <div className="w-25 theme-font">
                            <h5>SAML Intergreation</h5>
                        </div>
                        <div className="d-flex align-items-center">
                        <input  className="me-2"type="checkbox"/>
                        <div>
                            <h6 className="mb-0">SAML Enabled</h6>                            
                        </div>
                        </div>
                    </div>
                    <br/>
                    <div className="w-100 d-flex">
                        <div className="w-100 d-flex">
                            <h5 className="w-25 theme-font">SAML idp MetaData</h5>
                            <input
                            type="text"
                    ...
                    <div className="w-100 d-flex">
                        <div className="w-25 theme-font">
                            <h5>SAML Force Login</h5>
                        </div>
                        <div className="d-flex align-items-center">
                        <input  className="me-2"type="checkbox"/>
                        <div>
                            <h6 className="mb-0">Make SAML the primary login</h6>                            
                        </div>
                        </div>
                    </div>
                    <br/>
                    ...
                    <div className="w-100 d-flex">
                        <div className="w-100 d-flex">
                            <h5 className="w-25 theme-font">SAML Custom Settings</h5>
                            <input
                            type="text"
                            className="text-muted w-75 form-control"
